...
module.exports = function (controller) {
    ...
    controller.hears(["help", "who"], 'direct_message,direct_mention', function (bot, message) {
        ...
        text += "\n- " + bot.enrichCommand(message, "cheese") + ":  simple use of Botkit's thread conversation system";
        text += "\n- " + bot.enrichCommand(message, "drink") + ": illustes mutiple threaded conversation";
